    ...
    <div class="sb_nav">
        ...
        <div class="active b-r" id="sidebar" data-csnow="33" data-class3="0" data-jsok="2">
            <dl class="list-none navnow">
                <dt id='part2_33' class='on'><a href='${pageContext.request.contextPath}/abou_showInfoToAbou.action'
                                                title='公司简介' class="zm"><span>公司简介</span></a></dt>
            </dl>
            <dl class="list-none navnow">
                <dt id='part2_14'><a href='${pageContext.request.contextPath}/abou_showInfoToCompanyPhilosophy.action'
                                     title='公司理念' class="zm"><span>公司理念</span></a>
                </dt>
            </dl>
            <div class="clear"></div>
        </div>
