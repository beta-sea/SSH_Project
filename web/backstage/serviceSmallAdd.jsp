...
<div id="pageAll">
    ...
    <div class="page ">
        <form action="${pageContext.request.contextPath}/serviceSmall_addServiceSmallEnt.action" method="post">
            <!-- 上传广告页面样式 -->
            <div class="banneradd bor">
                ...
                <div class="baBody">
                    ...
                    <div class="bbD">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;服务名称：<input type="text" class="input3" name="serviceSmallEnt.name"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                    </div>
                    <div class="bbD">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价格：<input type="text" class="input3" name="serviceSmallEnt.price"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                    <div class="bbD">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;服务介绍：<input type="text" class="input3" name="serviceSmallEnt.serviceIntroduce"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                    <div class="bbD">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;服务类型：<input type="text" class="input3" name="serviceSmallEnt.serviceType"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                    <div class="bbD">
                        <p class="bbDP">
